...
\setbeamercolor{title}{fg=white,bg=\thisColor} % main title block on title page
\setbeamercolor{frametitle}{fg=white, bg=\thisColor} % all frames with titles
\setbeamercolor{normal text}{fg=black,bg=} % bg= makes all slide backgrounds transparent
\setbeamercolor{alerted text}{fg=\thisColor} % alerted text, highlighted enum items in this document
...
\input{../Math-and-Misc/examples/font-sizes}
